...
const validTestEnv = () => {
  ...
  if (!JR_SITE_TEST_DB_CONNECTION_URI) {
    console.error(
      'ERROR: JR_SITE_TEST_DB_CONNECTION_URI environment ' +
  ...
  if (!JR_SITE_TEST_DB_CONNECTION_USERNAME) {
    console.error(
      'ERROR: JR_SITE_TEST_DB_CONNECTION_USERNAME environment ' +
      'variable is not set. Exiting.'
    )
  ...
  if (!JR_SITE_TEST_DB_CONNECTION_PASSWORD) {
    console.error(
      'ERROR: JR_SITE_TEST_DB_CONNECTION_PASSWORD environment ' +
      'variable is not set. Exiting.'
    )
